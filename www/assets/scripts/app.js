...
define('MyJSController', function() {
	function Controller(node, message) {
		console.log(message);
	}
...
/**
 * Handles the generated server side code
 */
define('InitialJSLoader', ['XHPJS'], function (xhp) {
	return {
		handleServerJS: function (instances, calls) {
            return new xhp(instances, calls);
        }
	}
});